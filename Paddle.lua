...
--[[
    ...
    Side: 0 - Player 1 (left), 1 - Player 2 (right)
]]
...
function Paddle:center(yTarget)
    center = self.y + self.height / 2
    --center = math.floor(self.y + self.height / 2)
    --print(string.format("%d  %f", center, PADDLE_SPEED))
    --io.flush()
    if yTarget < center then
